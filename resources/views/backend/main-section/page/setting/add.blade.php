                        ...
                        <div class="col-sm-6 col-md-4">
                         ...
                         <div class="col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="link" value="{{$settings->link}}" class="form-control" placeholder="www.">
                            </div>
                         </div>
                         ...
                         <div class="col-sm-6 col-md-3">
                            <img id="showImage" src="{{ (!empty($settings->image)) ? url('backend/all-images/web/logo/'.$settings->image): url('backend/all-images/web/default/site.png') }}" alt="image" class="img-fluid avatar-lg rounded"/><br/>
                            <span class="badge rounded-pill"> <input class="avatar-ms" type="file" name="image" id="image"> </span>
                        </div>

                        <div class="col-sm-6 col-md-3">
                            <img id="showImage" src="{{ (!empty($settings->photo)) ? url('backend/all-images/web/logo/icon/'.$settings->photo): url('backend/all-images/web/default/favicon.png') }}" alt="image" width="10px" height="10px" class="img-fluid avatar-lg rounded"/><br/>
